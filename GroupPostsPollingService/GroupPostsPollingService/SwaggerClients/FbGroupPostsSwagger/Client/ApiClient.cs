...
namespace GroupPostsPollingService
{
    ...
    public partial interface IFbGroupPostsClient
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<bool> FbGroupPostAsync(System.Collections.Generic.IEnumerable<CreateGroupPostDto> body);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<bool> FbGroupPostAsync(System.Collections.Generic.IEnumerable<CreateGroupPostDto> body, System.Threading.CancellationToken cancellationToken);

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.17.0.0 (NJsonSchema v10.8.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class FbGroupPostsClient : IFbGroupPostsClient
    {
        private string _baseUrl = "";
        private System.Lazy<System.Text.Json.JsonSerializerOptions> _settings;

        public FbGroupPostsClient(string baseUrl)
        {
            BaseUrl = baseUrl;
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<GroupPostDto>>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<bool> FbGroupPostAsync(System.Collections.Generic.IEnumerable<CreateGroupPostDto> body)
        {
            return FbGroupPostAsync(body, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<bool> FbGroupPostAsync(System.Collections.Generic.IEnumerable<CreateGroupPostDto> body, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/FbGroupPost");
    ...
    public partial class CreateGroupPostDto
    {
        ...
        public static CreateGroupPostDto FromJson(string data)
        {

            var options = new System.Text.Json.JsonSerializerOptions();

            return System.Text.Json.JsonSerializer.Deserialize<CreateGroupPostDto>(data, options);
    ...
    public partial class GroupPostDto
    {
        ...
        public static GroupPostDto FromJson(string data)
        {

            var options = new System.Text.Json.JsonSerializerOptions();

            return System.Text.Json.JsonSerializer.Deserialize<GroupPostDto>(data, options);
